    ...
    childRoutes: [
        {
            ...
            indexRoute: {component: require('./components/pages/dashboard/Calendar')},
            childRoutes: [
                require('./components/pages/dashboard/Calendar'),
                require('./components/pages/dashboard/Charts'),
                require('./components/pages/dashboard/New'),
                require('./components/pages/dashboard/Settings')
            ]
        },
        {
            path: '/login',
